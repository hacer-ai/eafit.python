...
st.set_page_config(
    page_title="Nodo + Introducción a Python",
    page_icon="🧠",
...
st.sidebar.title("Nodo + Introducción a Python")
st.sidebar.divider()
st.sidebar.markdown("Mentor Introducción a Python", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/10/python.png"/>""", unsafe_allow_html=True)
